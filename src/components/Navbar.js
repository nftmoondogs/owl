    ...
    <nav className="bg-black py-4">
      <div className="container mx-auto flex justify-between items-center px-4 xl:px-0">
        <a href="/" className="flex items-center">
          <img src="https://i.ibb.co/89ZsmGd/pwc-phoenix-purple.gif" alt="WOOF Logo" className="h-12" />
        </a>
        <div className="flex items-center">
          {/* Social Icons */}
          <a href="https://twitter.com/woofsoltoken" target="_blank" rel="noopener noreferrer" className="text-white px-3">
          ...
          <a href="https://t.me/owntokensol" target="_blank" rel="noopener noreferrer" className="text-white px-3">
